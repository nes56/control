...
import frc.robot.subsystems.HatchPanelsSystem.ArmPosition;
...
public class DriverInterface {
  ...
  //  public Joystick xbox;
    ...
    public static int PUT_HATCH_BY_VISION = 6;
    public static int TAKE_HATCH_BY_VISION = 5;
...
//      calcKF.whenPressed(new CalcKF());
      ...
      putHatchByVision = new JoystickButton(xbox, PUT_HATCH_BY_VISION);
      putHatchByVision.whenPressed(new CalcCameraData(true));
      takeHatchByVision = new JoystickButton(xbox, TAKE_HATCH_BY_VISION);
